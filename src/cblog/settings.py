...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.csmirimxvqn2.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesmaliblog' # please enter your s3 bucket name
